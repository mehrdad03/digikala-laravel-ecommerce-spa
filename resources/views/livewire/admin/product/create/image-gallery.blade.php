                ...
                <div class="multiple-file-upload">
                    <div class="d-flex flex-wrap">
                        ...
                        @foreach($product->images as $photo)
                            ...
                            <div class="item  m-2">
                                <img src="/products/{{$product->id}}/small/{{$photo->path}}" class="w-100 rounded" alt="">
                                <div class="d-flex justify-content-between align-items-center mt-2 bg-dark p-2 rounded">
                                    <div class="form-check form-check-primary form-check-inline">
                                        <input type="radio" id="cover_image" class="form-check-input"
                                               {{@$photo->id==@$product->coverImage->id ? 'checked' : ''}}  wire:confirm="آیا مطمئن هستید؟" wire:click="setCoverOldImage({{$photo->id}})"
                                               name="cover_image">
                                        <label for="cover_image" class="text-white">به عنوان کاور</label>
